    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="m-t-0 header-title"><b>All Draft Jobs</b></h4>
                        <p class="text-muted font-13">
                            All draft jobs will be visible here.
                        </p>
                    </div>
                    <div class="col-md-6">
                        ...
                        <table class="table table-bordered m-0">
                            @if(count($posts))
                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        <td scope="row"><a
                                                    href="{!! route('employee.posts.edit.draft', [$post->hashid,'edit-draft']) !!}">#{!! $post->post_id !!}</a>
                                        </td>
                                        <td>{!! $post->name !!}</td>
                                        ...
                                        <td>
                                            ...
                                            <div class='btn-group'>
                                                ...
                                                @if($post->status == 3)
                                                    <a href="{!! route('employee.posts.edit.draft', [$post->hashid,'edit-draft']) !!}"
                            ...
                            @else
                                <tr>
                                    <span>There is not draft job that can be publish for now.</span>
                                </tr>
                            @endif
                        </table>
                    </div>
