                ...
                @foreach ($posts as $job)
                    <div class="recent-job-list-home"><!-- Tabs content -->
                        <div class="job-list-logo col-md-1">
                            ...
                            {{--@endif--}}
                            {{--@endif--}}
                            <img src="#" class="img-responsive" alt="{!! $job->name !!}"/>
                        </div>
                        <div class="col-md-5 job-list-desc">
                            <h6>{!! \Illuminate\Support\Str::limit($job->name, 35) !!}</h6>
                            <p>{!! \Illuminate\Support\Str::limit($job->job_description, 50) !!}</p>
                        </div>
                        <div class="col-md-6 full">
                            <div class="job-list-location col-md-5">
                                <h6>
                                    <i class="fa fa-map-marker"></i>{!! Helper::relationship($job->city) !!}
                                </h6>
                            </div>
