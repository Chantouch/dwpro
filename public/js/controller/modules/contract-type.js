...
const contract = new Vue({
    ...
    methods: {
        fetchItems (page)
        {
            this.$http.get('/api/admin/modules/contract-types?page=' + page).then((response) => {
        ...
        createItem(){
            ...
            this.$http.post('/api/admin/modules/contract-types', input).then((response) => {
        ...
        updateItem(id){
            ...
            this.$http.patch('/api/admin/modules/contract-types/' + id, input).then((response) => {
                this.changePage(this.pagination.current_page);
                this.newItem = {
                    'name': '',
                    'description': '',
        ...
        deleteItem(item){
            ...
            if (con) {
                this.$http.delete('/api/admin/modules/contract-types/' + item.id).then((response) => {
                    this.changePage(this.pagination.current_page);
