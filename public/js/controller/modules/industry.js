...
const business = new Vue({
    ...
    methods: {
        fetchItems (page)
        {
            this.$http.get('/api/admin/modules/industries?page=' + page).then((response) => {
        ...
        createItem(){
            ...
            this.$http.post('/api/admin/modules/industries', input).then((response) => {
        ...
        updateItem(id){
            ...
            this.$http.patch('/api/admin/modules/industries/' + id, input).then((response) => {
                this.changePage(this.pagination.current_page);
                this.newItem = {
                    'name': '',
                    'description': '',
        ...
        deleteItem(item){
            ...
            if (con) {
                this.$http.delete('/api/admin/modules/industries/' + item.id).then((response) => {
                    this.changePage(this.pagination.current_page);
