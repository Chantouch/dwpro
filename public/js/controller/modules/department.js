...
const business = new Vue({
    ...
    methods: {
        fetchItems (page)
        {
            this.$http.get('/api/admin/modules/departments?page=' + page).then((response) => {
        ...
        createItem(){
            ...
            this.$http.post('/api/admin/modules/departments', input).then((response) => {
        ...
        updateItem(id){
            ...
            this.$http.patch('/api/admin/modules/departments/' + id, input).then((response) => {
                this.changePage(this.pagination.current_page);
                this.newItem = {
                    'name': '',
                    'description': '',
        ...
        deleteItem(item){
            ...
            if (con) {
                this.$http.delete('/api/admin/modules/departments/' + item.id).then((response) => {
                    this.changePage(this.pagination.current_page);
